function [error_sign, RMSE, ME, MAE, NSE, correlation, residue_correlation] = f_performance_det(z_simulated, z_true)
    ...
    correlation = corr(z_true, z_simulated);
    
    % Residue Correlation
    residue_correlation = corr(z_true, error_sign);
