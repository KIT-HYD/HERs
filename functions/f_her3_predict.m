function [pmf_pred_nn, target_idx_zero_neigh_pred] = f_her3_predict(x_cal, y_cal,z_cal, x_target, y_target, her)
...
% - 2020/06/16 Diego Vieira: truncate target pmf when outside range of
% edges_z (ST copy from f_her3_predict_NOnugget)
